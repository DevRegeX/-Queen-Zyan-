...
let handler = async (m, { conn, args, isPrems, isOwner, usedPrefix, command }) => {
  if (!args || !args[0]) throw `🎖 Example:\n${usedPrefix + command} https://youtu.be/bsisjkskssjsjsb`;
  if (!args[0].match(/youtu/gi)) throw `❤️ Queen Zyan║🇱🇰  Verify that YT link`;
